...
const PORTFOLIO = {
  ...
  tagline: "Leaving things better than I found them",
  ...
  experience: [
    ...
    },
    {
      ...
      In my role I leveraged CAD, AI and simulation tools to identify areas of risk before product launch.
        <br><br>
  ...
  projects: [
    ...
    },
    {
      ...
      I helped in the prototyping phase, fabricating and creating several potential designs before settling on the final form. I also aided in CAD modelling several parts of the robot using Onshape.
